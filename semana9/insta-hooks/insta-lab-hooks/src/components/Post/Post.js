...
const Post = (props) => {
  ...
  const enviarComentario = (comentario) => {
    ...
    setComentarios(listaDeComentarios, false, numeroComentarios + 1);
  };
  ...
  const caixaDeComentario = comentando ? (
    ...
    //Import dele na linha 5.
    <SecaoComentario enviarComentario={enviarComentario} />
  ) : (
    // Funcao map sendo feita na propriedade comentarios do estado.
    //Ou seja, está sendo pego todos os
    // comentários do estado para serem renderizados na tela,
    //dentro do componente CommentContainer
